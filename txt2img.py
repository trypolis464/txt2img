...
def generate(width: int, height: int, text: str, bg: Optional[str]="white", text_x: Optional[int]=10, text_y: Optional[int]=10, fg: Optional[str]="black", filename: Optional[str]="image.png"):
 """Generate an image.
 Parems:
